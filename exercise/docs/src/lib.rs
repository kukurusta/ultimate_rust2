...
//! but no agreed upon botanical or scientific meaning. The term pumpkin is sometimes
//! used interchangeably with "squash" or "winter squash", and is commonly used for
//! cultivars of Cucurbita argyrosperma, Cucurbita ficifolia, Cucurbita maxima, Cucurbita moschata,
//! and Cucurbita pepo.
//! ![Punkin image](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/FrenchMarketPumpkinsB.jpg/700px-FrenchMarketPumpkinsB.jpg)
